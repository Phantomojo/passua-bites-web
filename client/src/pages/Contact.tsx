  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--pb-bg)" }}>
        ...
        >
          ...
          >
            <div style={infoStyle}>
              ...
              >
                Find us opposite Rainbow Resort in Ruiru. Easy to locate —
            ...
            <div style={infoStyle}>
              ...
              >
                Call for quick orders or inquiries during business hours.
              </div>
            </div>
            <div
              style={{ ...infoStyle, borderLeft: "3px solid var(--pb-ember)" }}
            >
              ...
              >
                Fastest way to order. We respond quickly.
              </div>
            </div>
            <div style={infoStyle}>
              ...
              {[
                ...
                >
                  <span>{day}</span>
                  <span style={{ color: "var(--pb-ivory2)" }}>{hrs}</span>
                </div>
              ))}
            </div>
            <div
          ...
          >
            ...
            {sent ? (
              <div style={{ textAlign: "center", padding: "3rem 1rem" }}>
                ...
                >
                  We'll get back to you soon. For urgent orders, WhatsApp us
                  directly.
                </p>
              </div>
            ) : (
      ...
      <section className="pb-section-mobile" style={{ padding: "3rem 2.5rem" }}>
        ...
        >
          Opp Rainbow Resort, Ruiru — call or WhatsApp for precise directions.
        </p>
      </section>
